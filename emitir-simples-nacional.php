			...
			<div id="content">
				...
				<div class="container-fluid" id="container-wrapper">
					<div class="d-sm-flex align-items-center justify-content-between mb-4">
						<h1 class="h3 mb-0 text-gray-800">Emissão de Simples Nacional</h1>
						<ol class="breadcrumb">
							<li class="breadcrumb-item"><a href="home.php">Home</a></li>
							<li class="breadcrumb-item"><a href="seleciona-cliente.php">Simples Nacional</a></li>
							...
							<div class="card mb-4">
								<div class="card-body">
									<form name="formCliente" action="cadastro-cliente.php" method="POST">
										<div class="row">
											<div class="form-group col-md-4">
												<label for="idPeriodoApuracao">Período de Apuração</label>
												<input type="date" class="form-control" id="idPeriodoApuracao" name="periodoApuracao" required="">
											</div>
										</div>
										<div class="row">
											<div class="form-group col-md-4">
												<label for="idReceitaMercadoInterno">Receita Mercado Interno (R$)</label>
												<input type="text" class="form-control" id="idReceitaMercadoInterno" name="receitaMercadoInterno" required="">
											</div>
											<div class="form-group col-md-4">
												<label for="idReceitaMercadoExterno">Receita Mercado Externo (R$)</label>
												<input type="text" class="form-control" id="idReceitaMercadoExterno" name="receitaMercadoExterno" required="">
											</div>
											<div class="form-group col-md-4">
												<label for="idReceitaPrestacaoServico">Receita Prestação Serviço (R$)</label>
												<input type="text" class="form-control" id="idReceitaPrestacaoServico" name="receitaPrestacaoServico" required="">
											</div>
										</div>
										<div class="row">
											<div class="form-group col-md-4">
									...
									-->
										...
										<button type="submit" class="btn btn-primary">Trasmitir</button>
										<a href="seleciona-emissao-simples-nacional.php" class="btn btn-danger">Cancelar</a>
									</form>
								</div>
							</div>
