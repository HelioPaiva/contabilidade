	...
	<div id="wrapper">
		...
		<div id="content-wrapper" class="d-flex flex-column">
         ...
         <div class="d-sm-flex align-items-center justify-content-between mb-4">
          <h1 class="h3 mb-0 text-gray-800">Status Nota Fiscal</h1>
          <ol class="breadcrumb">
           <li class="breadcrumb-item"><a href="home.php">Home</a></li>
           <li class="breadcrumb-item">Nota Fiscal</li>
           <li class="breadcrumb-item active" aria-current="page">Status Nota Fiscal</li>
         </ol>
       </div>
       ...
       <div class="row">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><?php echo '20/06/2020';//ucwords(strtolower($alunoBD['responsavel']));?></td>
            <td><?php echo '1.567,90';//ucwords(strtolower($alunoBD['responsavel']));?></td>
            <td><?php echo 'Em Aberto';//ucwords(strtolower($alunoBD['responsavel']));?></td>
            <td>
              <a href="" class="btn btn-sm btn-primary">Pago</a>
            </td>
          </tr>
          <tr>
            ...
            <td><?php echo '22/06/2020';//ucwords(strtolower($alunoBD['responsavel']));?></td>
            <td><?php echo '5.567,90';//ucwords(strtolower($alunoBD['responsavel']));?></td>
            <td><?php echo 'Pago';//ucwords(strtolower($alunoBD['responsavel']));?></td>
            <td>
              <a href="#" class="btn btn-sm btn-primary">Pago</a>
            </td>
          </tr>
